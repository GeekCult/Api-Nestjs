...
const defaultConfig = {
    ...
    entities: [company_entity_1.Company, user_entity_1.User, auth_entity_1.UserAuth, parking_entity_1.Parking, upload_entity_1.Upload, company_entity_1.Company, reports_entity_1.Reports],
    logging: true,
};
