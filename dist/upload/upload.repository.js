...
let UploadRepository = class UploadRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(upload_entity_1.Upload, dataSource.createEntityManager(), dataSource.createQueryRunner());
